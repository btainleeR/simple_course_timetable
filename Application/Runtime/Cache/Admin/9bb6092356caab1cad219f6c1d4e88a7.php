        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>班级管理 </h1>
                    <button class="btn btn-info" onclick="javascript:window.location = '<?php echo U('Admin/Myclass/add');?>'"><span class="glyphicon glyphicon-plus"></span>新增班级</button>
                </div>
                <table class="table table-bordered text-center">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr id="tr<?php echo ($vo["id"]); ?>">
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><?php echo ($vo["number"]); ?></td>
                            <td><?php echo (getSubjectNameById($vo["zhuanye"])); ?></td>
                            <td>
                                <button class="btn btn-primary" onclick="javascript:edit(<?php echo ($vo["id"]); ?>)"><span class="glyphicon glyphicon-pencil"></span>修改</button>
