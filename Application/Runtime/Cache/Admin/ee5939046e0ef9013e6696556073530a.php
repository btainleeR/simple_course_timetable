            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?php echo ($studentinfo['name']); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="number" id="number" class="form-control" value="<?php echo ($studentinfo['number']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="sex" class="control-label">性别:</label>
                        <select name="sex" id="sex" class="form-control">
                            <option value="0" <?php if($studentinfo['sex'] == 0): ?>selected<?php endif; ?> >男</option>
                            <option value="1" <?php if($studentinfo['sex'] == 1): ?>selected<?php endif; ?> >女</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="zhuanye" id="zhuanye" class="form-control">
                            <option value=""></option>
                            <?php if(is_array($subjectinfo)): foreach($subjectinfo as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($studentinfo['id'] == $vo['id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="grade" class="control-label">年级:</label>
                        <input type="text" name="grade" id="grade" class="form-control" value="<?php echo ($studentinfo['grade']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="iclass" class="control-label">班级:</label>
                        <select name="class" id="iclass" class="form-control">
                            <option value=""></option>
                            <?php if(is_array($classinfo)): foreach($classinfo as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($studentinfo['class'] == $vo['id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
